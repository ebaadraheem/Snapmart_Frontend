...
import SaleReturnWithInvoice from "./SaleReturnWithInvoice";
import SaleReturnWithoutInvoice from "./SaleReturnWithoutInvoice";
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md flex flex-col h-full">
      ...
      <motion.div
        ...
        className="flex-grow" 
      >
        {returnMode === "with-invoice" && <SaleReturnWithInvoice />}
        {returnMode === "without-invoice" && <SaleReturnWithoutInvoice />}
      </motion.div>
    </div>
  );
};
